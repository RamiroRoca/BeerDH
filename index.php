                    ...
                    <div class="abouts_content">
                        ...
                        <div class="col-md-6">
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                ...
                                <a href="" class="btn btn-primary">About us here</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="main_pakeg_content">
                    <div class="row">
                        <div class="head_title text-center">
                            <h4>Know the menu</h4>
                            <h3 style="font-family: 'Pacifico', cursive;" >Know the price</h3>
                        </div>
